                ...
                <div style={{ marginTop: 45, width: '100%', backgroundColor: Colors.white(), paddingTop: 50, paddingLeft: 15, paddingRight: 15 }}>
                    ...
                    <div className="productNameAndPrice">
                        <h2 
                            ...
                            style={{color: Colors.fontColor()}}>{productDetails.name}
                        </h2>
                        <h3 className="productPrice">
                            <span className="actutalSellingPrice" style={{color: Colors.fontColor()}}>&#8377; {productDetails.price}</span>
                            <span className="mrpPrice" style={{color: Colors.fontGray()}}>{productDetails.mrp}</span>
                            {Math.floor(Number(productDetails.mrp) - Number(productDetails.price)) ? 
                                <span className="offPercantage" style={{color: Colors.green()}}>{calculateDiscount(Number(productDetails.mrp), Number(productDetails.price))}% off</span>
                            : null }
                        </h3>
                    </div>
                </div>
